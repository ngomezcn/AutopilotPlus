...
namespace sim {
	namespace flightmodel {
		namespace position {
			...
			DREF elevation("sim/flightmodel/position/elevation", 10);
			DREF latitude("sim/flightmodel/position/latitude", 10);
			DREF longitude("sim/flightmodel/position/longitude", 10);
		}
	}
}
